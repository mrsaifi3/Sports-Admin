...
const markStatusApproved = async (req, res) => {
    try {
        ...
        await sendWithAttachment(
            ...
            Congratulations! Your profile has been approved by Mr Saifi. Below are your enrollment details:
            ...
            Thank you for registering with Mr Saifi.

            Best regards,
            Mr Saifi Team`,
            `<p>Dear ${atheleteData.athleteName},</p>
            <p>Congratulations! Your profile has been approved by Mr Saifi. Below are your enrollment details:</p>
            <table>
            <tr>
            ...
            <p>Thank you for registering with Mr Saifi.</p>
...
const markStatusRejected = async (req, res) => {
    ...
    await sendWithAttachment(
        ...
        We regret to inform you that your profile has been rejected by Mr Saifi. Below are the details:
